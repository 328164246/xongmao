...
public class RecyclerAdapter_five extends RecyclerView.Adapter {
    private List<Bean.DataBean.ChinaliveBean.ListBeanXX> list ;
    private Context context;

    public RecyclerAdapter_five(List<Bean.DataBean.ChinaliveBean.ListBeanXX> list, Context context) {
        this.list = list;
